...
<<<<<<<< Updated upstream:aws-gov/tf/modules/sra/databricks_workspace/workspace_security_modules/uc_catalog/uc_catalog.tf
...
>>>>>>>> Stashed changes:aws-gov/tf/modules/sra/databricks_workspace/workspace_security_modules/uc_catalog/main.tf
}
