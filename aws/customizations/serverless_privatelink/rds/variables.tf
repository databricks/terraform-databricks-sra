...
variable "resource_prefix" {
  description = "Prefix used for naming and tagging resources. Kept short because the NLB and target group names are \"<resource_prefix>-rds-nlb\"/\"<resource_prefix>-rds-tg\" and AWS caps load balancer and target group names at 32 characters."
  type        = string
